...
.doctors
  ...
  .doctors__content(:class="{ 'doctors__content--hide': hideDoctors }")
    ...
    .textgroup
      h3.textgroup__title.primary_heading Наши врачи
      p.textgroup__text.card_desc У нас работают профессионалы своего дела. Врачи регулярно повышают квалификацию и стажируются для того, чтобы наши пациенты всегда были довольны результатом.
  .doctors__controls
    button.swipe-button.swiper-button--prev(
      @click="prevSlide",
...
export default {
  data() {
    return {
      ...
      doctors: [
        {
          fullName: 'Романцов Александр Валентинович',
          abbrName: 'Романцов А.В.',
          title: "Главный врач, имплантолог, стоматолог, стоматолог-ортопед, стоматолог-хирург",
          skills: [
        ...
        {
          fullName: 'Иваненко Мария Дмитриевна',
          abbrName: 'Иваненко М.Д.',
          title: 'Врач стоматолог-терапевт, эндодонтист-микроскопист',
          skills: [
        ...
        {
          fullName: 'Иванчина Татьяна Александровна',
          abbrName: 'Иванчина Т.А.',
