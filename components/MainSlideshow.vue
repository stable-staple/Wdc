...
.main-slideshow
  .main-slideshow__backdrop.full-bleed
    swiper.main-slideshow__slides(ref="mainSwiper", :options="swiperOptions")
  ...
  .main-slideshow__content
    .main-slideshow__textgroup(
      :class="{ 'main-slideshow__textgroup--fade': contentTransition }"
    )
      h1.primary_heading.main-slideshow__title {{ textSlides[currentTextSlide].title }}
      p.primary_desc.main-slideshow__desc Импланты швейцарского качества с технологией максимальной приживаемости
      button.button--more.main-slideshow__desktop-btn.card_desc Смотреть подробнее
    .main-slideshow__green-implants
      picture
        source(
          srcset="~assets/img/green_implants_mobile.png",
          media="(max-width: 768px)"
        )
        img.main-slideshow__green-implants__img(
          src="~assets/img/green_implants.png"
        )
    ...
    .main-slideshow__timers--mobile
      svg.slide-timer(
        :class="{ 'slide-timer--active': currentTextSlide === 0 }",
        width="6",
        height="6",
        viewbox="0 0 6 6",
        fill="none",
      ...
      svg.slide-timer(
        :class="{ 'slide-timer--active': currentTextSlide === 1 }",
        width="6",
        height="6",
        viewbox="0 0 6 6",
        fill="none",
        ...
        circle(cx="3", cy="3", r="3", fill="white")
      svg.slide-timer(
        :class="{ 'slide-timer--active': currentTextSlide === 2 }",
        width="6",
        height="6",
        viewbox="0 0 6 6",
        fill="none",
    ...
    .main-slideshow__swipe-controls
      button.swipe-button.swipe-button--dark.swiper-button--prev(
        @click="prevSlide",
      ...
      button.swipe-button.swipe-button--dark.swiper-button--next(
        @click="nextSlide",
  ...
  methods: {
    nextSlide: function () {
      if (
        ...
        this.currentTextSlide >= this.swiper.slides.length - 1 ||
